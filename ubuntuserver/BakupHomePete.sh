#!/bin/bash
# Simple Backup Scrpt to Backup Pete's Home Directory Nightly
# Peter Talbott
...
export LOG_FILE="$BACKUP_PATH/$(date +%w)-pete_home.log"
export BACKUP_FILE="$BACKUP_PATH/$(date +%w)-pete_home.tar.gz"
export BACKUP_SOURCE="/home/pete"
