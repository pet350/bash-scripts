...
function INIT_MOUNT_POINTS()
{
  ...
  declare -ag DEVICE_ARRAY=('UUID=fe65fa76-2575-416f-8fe3-30f7b37a847f' 'UUID=fe65fa76-2575-416f-8fe3-30f7b37a847f' \
			    'UUID=fe65fa76-2575-416f-8fe3-30f7b37a847f' 'UUID=fe65fa76-2575-416f-8fe3-30f7b37a847f' \
			    'UUID=fe65fa76-2575-416f-8fe3-30f7b37a847f' 'UUID=fe65fa76-2575-416f-8fe3-30f7b37a847f' \
			    'UUID=fe65fa76-2575-416f-8fe3-30f7b37a847f' 'UUID=fe65fa76-2575-416f-8fe3-30f7b37a847f');
  declare -ag SUBVOL_ARRAY=('@home' '@build' '@iso' '@movies' '@mp3drive' '@porn' '@roms' '@storage');
  declare -ag MOUNT_ARRAY=('/home' '/opt/build' '/opt/iso' '/opt/movies' '/opt/mp3drive' '/opt/porn' '/opt/roms' '/opt/storage');
...
function INIT_EXT_MOUNT_POINTS()
{
  ...
  declare -ag DEVICE_ARRAY=("UUID=e3c8c869-6b17-4ff1-9f34-7e94ef91e901" "UUID=804a9fe8-7766-4e3f-8907-a261b920c461" \
			    "UUID=28896cda-b06b-4fe8-8a25-187ebf3808b3");
