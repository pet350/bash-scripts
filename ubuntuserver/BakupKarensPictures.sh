#!/bin/bash
# Simple Backup Scrpt to Backup Karen's Pictures Nightly
# Peter Talbott
...
export LOG_FILE="$BACKUP_PATH/$(date +%w)-Karens_pictures.log"
export BACKUP_FILE="$BACKUP_PATH/$(date +%w)-Karens_pictures.tar.gz"
export BACKUP_SOURCE="/home/karen/My Pictures"
