...
function INIT_ARRAYS()
{
 ...
 "-nosub -noautosub -ovc x264 -x264encopts pass=1:bitrate=1000:8x8dct:i8x8 -vf scale=720:480 -af volnorm=1 -oac pcm  -o" \
 "-nosub -noautosub -ovc x264 -x264encopts pass=2:bitrate=1000:8x8dct:i8x8 -vf scale=720:480 -af volnorm=1 -oac copy -o" \
 ...
 "-nosub -noautosub -ovc xvid -xvidencopts pass=2:bitrate=1000:trellis:chroma_opt:vhq=4:bvhq=1:quant_type=mpeg:max_bframes=0:nogmc:noqpel -vf scale=720:480 -af volnorm=1 -oac mp3lame -lameopts cbr:br=192 -o" );
  ...
  declare -ag MENCODER_OUTPUT_ARRAY=(	"/dev/null" "$OUTPUT_FILE" "/dev/null" "$OUTPUT_FILE" \
