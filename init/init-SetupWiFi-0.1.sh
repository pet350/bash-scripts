...
# Required-Start:    $network $syslog $openvswitch-switch
# Required-Stop:     $network $syslog $openvswitch-switch
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: WiFi System Configurations
# Description:       Initialize WiFi System Configurations
### END INIT INFO
# chkconfig: 2345 08 08

export __RUN_PREFIX="/usr/local/sbin"
export __PID_PREFIX="/run"
export __SCRIPT_NAME="SetupWiFi.sh"
