...
### BEGIN INIT INFO
# Provides:          Wait4LDAP
# Required-Start:    $network $syslog openvswitch-switch wifi-configuration
# Required-Stop:     $network $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Waits For LDAP Connection
# Description:       Waits For LDAP Connection
### END INIT INFO
# chkconfig: 2345 08 08

export __RUN_PREFIX="/usr/local/sbin"
export __PID_PREFIX="/run"
export __SCRIPT_NAME="Wait4LDAP.sh"
