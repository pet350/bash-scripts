#! /bin/bash
### BEGIN INIT INFO
# Provides:          SoundModules
# Required-Start:    $network $remote_fs $syslog $all
# Required-Stop:
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Modprobe All Sound Modules
# Description:       Modprobe All Sound Modules
### END INIT INFO
