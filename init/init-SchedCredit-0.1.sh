#! /bin/bash
### BEGIN INIT INFO
# Provides:          Xen-Sched-Credit
# Required-Start:    $network $remote_fs $syslog $xenDomains.sh $all
# Required-Stop:
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Set Xen Schedule-Credit on Xen Domains
# Description:       Set Xen Schedule-Credit on Xen Domains
### END INIT INFO
...
export __SCRIPT_NAME="SchedCredit.sh"
