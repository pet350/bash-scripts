#!/bin/bash
# init script by: Peter Talbott

### BEGIN INIT INFO
# Provides:          openvswitch-configuration
# Required-Start:    $network $remote_fs $syslog $openvswitch-switch
# Required-Stop:     $network $remote_fs $syslog $openvswitch-switch
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Open vSwitch System Configurations
# Description:       Initialize Open vSwitch System Configurations
### END INIT INFO
# chkconfig: 2345 08 08

export __RUN_PREFIX="/usr/local/sbin"
export __PID_PREFIX="/run"
export __SCRIPT_NAME="OpenVSwitch.sh"
