#! /bin/bash
### BEGIN INIT INFO
# Provides:          MountPoints
# Required-Start:    $network $remote_fs $syslog $all
# Required-Stop:
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Mount Filesystems Not Listed in /etc/fstab
# Description:       Mount Filesystems Not Listed in /etc/fstab
### END INIT INFO
