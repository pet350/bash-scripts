#! /bin/bash
### BEGIN INIT INFO
# Provides:          Domain-0-Sched-Credit
# Required-Start:    $network $remote_fs $syslog $xenDomains.sh $all
# Required-Stop:
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Set Xen Schedule-Credit on Xen Domain-0
# Description:       Set Xen Schedule-Credit on Xen Domain-0
### END INIT INFO
...
export __SCRIPT_NAME="Domain-0.sh"
