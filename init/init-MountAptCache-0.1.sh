#! /bin/bash
### BEGIN INIT INFO
# Provides:          Mount-APT-Cacher-NG-Disk
# Required-Start:    $local_fs $syslog
# Required-Stop:
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Prepare Apt Cacher NG Disk
# Description:       Prepare Apt Cacher NG Disk
### END INIT INFO
...
export TARGET="/var/cache/apt-cacher-ng"
export OWNER="apt-cacher-ng"
export GROUP="apt-cacher-ng"
export MOUNT_OPTION=""
...
function do_START()
{
    ...
    mount $MOUNT_OPTION $DEVICE $TARGET $VERBOSE
    RETVAL=$?
...
function do_HELP()
{
	...
	printf "%-15s\t\t%-25s\n" "-h or --help" "Disply This Help Message"
        printf "%-15s\t\t%-25s\n" "start" "Mount APT-CACHER-NG Disk"
        printf "%-15s\t\t%-25s\n" "stop" "Unmount APT-CACHER-NG Disk"
