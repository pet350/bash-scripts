...
export DEVICE_ID="pci-0000:00:02.0-usb-0:7:1.0-video-index0"
export V4L_PREFIX="/dev/v4l/by-path"
export DEVICE_NAME="$V4L_PREFIX"/"$(a=-1; for X in $(ls -lh $V4L_PREFIX/$DEVICE_ID); do ((a++)); done; echo $X)"
