...
declare -a INSTALL_PACKAGE_ARRAY=( "python38-opengl-accelerate python38-loguru shared-python-startup python38-charset-normalizer python38-PyYAML python38-yarl python38-pyspnego python38-typed-ast python38-curses python38-power\n" \
	"python36-sphinxcontrib-httpdomain libpython3_8 python38-ipaddr python39-dragonmapper python38-Automat python38-ordered-set python38-appdirs python38-setuptools python38-pip python38-rpm\n" \
	"python3-solv python38-importlib-metadata python36-base python39-base python38-zhon python38-six python38-pycurl python38-ply python38-iniconfig python38-idna python38-decorator python38-colorama\n" \
