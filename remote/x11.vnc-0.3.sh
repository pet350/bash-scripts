...
declare -ag VNC_OPT_ARRAY=("-rfbauth" "/home/$USERNAME/.vnc/passwd" "-ncache" "10" "-bg" "-noipv6" "-reopen" "-accept" "'popup'" "-gone" "'popup'" "-overlay" "-forever" "-noxdamage" "-shared" "-gui" "tray=minimal,iconfont=14x17");
