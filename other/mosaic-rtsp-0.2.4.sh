...
if [ ${#STREAM_PASS}		-eq 0 ]; then export STREAM_PASS="admin";		fi
...
function ASSEMBLE_ARRAY()
{
  ...
  declare -ag INPUT_ARRAY=( \
	"-rtsp_transport" "tcp" "-i" "rtsp://admin:maiden666@$STREAM_1_ADDRESS:$((STREAM_1_PORT))/ch0_1.264" \
	"-rtsp_transport" "tcp" "-i" "rtsp://admin:maiden666@$STREAM_2_ADDRESS:$((STREAM_2_PORT))/ch0_1.264" \
	"-rtsp_transport" "tcp" "-i" "rtsp://admin:maiden666@$STREAM_3_ADDRESS:$((STREAM_3_PORT))/ch0_1.264" \
	"-rtsp_transport" "tcp" "-i" "rtsp://admin:maiden666@$STREAM_4_ADDRESS:$((STREAM_4_PORT))/ch0_1.264" );
