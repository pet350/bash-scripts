...
## What's New in 0.2.5?
# TOTAL_DOORS gets set by number of variables stored in DOOR_SIGNAL_ARRAY
# Added RI to before mentioned DOOR_SIGNAL_ARRAY for third door
...
if [ ${#CFG_FILE}	-eq 0 ]; then export CFG_FILE="/etc/default/DoorEvent.conf";			fi
...
if [ ${#TOTAL_DOORS}	-eq 0 ]; then declare -ig TOTAL_DOORS=${#DOOR_SIGNAL_ARRAY[@]};			fi
