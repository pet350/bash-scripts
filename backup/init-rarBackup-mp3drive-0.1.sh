#! /bin/bash
### BEGIN INIT INFO
# Provides:          RAR-Backup-MP3Drive
# Required-Start:    $network $remote_fs $syslog $xenDomains.sh $all
# Required-Stop:
# Default-Start:
# Default-Stop:      0 1 6
# Short-Description: Perform RAR Backup of MP3Drive
# Description:       Perform RAR Backup of MP3Drive
### END INIT INFO
...
export __OPTIONS="--mp3drive --verbose"
